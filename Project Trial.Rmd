...
# The data above was just a test trial in order to determine what commands were needed in order to find the mean. Now that this is accomplished we can apply the same commands and others to anaylze the capstone data. 
